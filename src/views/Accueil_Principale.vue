<template>
  <div>
      ...
      <v-flex v-for="(Annonce, index) in Annonces" :key="Annonce.titre">
        <v-card class="text-center ma-3 card2 grey lighten-3">
          <div class="annonce-element">
            ...
            <v-responsive >
              <v-avatar tile width="250" height="150" class="white lighten-2">
    ...
    <h1 class="section-title" style="margin-left:11px">Les signalements</h1>
    ...
    <div class="area cards" style="margin-left:-30px;">
  ...
  async created() {
    try {
      ...
      const res = await axios.get(
        `http://localhost:8080/api/madrasa-tic/user/getAllReportsByUserAcc`
      );
