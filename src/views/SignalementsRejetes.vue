<template>
    <div class="LesSignalements">
        <h1 class="subheading grey--text">Signalements Rejetés</h1>
        <v-container>
      ...
      ></v-img>
                    ...
                    <div class="grey--text" rows="1"><strong>Motif : </strong>{{Signalement.motif}}</div>
                    </v-card-text>
  ...
  async created() {
    try {
      ...
      const res = await axios.get(
        `http://localhost:8080/api/madrasa-tic/moderator/getAllRejectedReportsByByModerator`
      );
