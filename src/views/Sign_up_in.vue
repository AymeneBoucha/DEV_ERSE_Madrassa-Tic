              ...
              <v-window v-model="step">
                  ...
                  <v-row>
                    <v-col cols="12" md="8">
                      <v-card-text class="mt-12">
                        <h1 class="text-center blue-grey--text display-2 text--darken-3">Authentification</h1>
                      ...
                      <router-link to="/Forgot_password" class="text-center mt-4">Mot de passe oublié ?</router-link>
                      </v-card-text>
                      <div class="text-center mt-3">
                        <v-btn class="cnx" rounded color="#37474F" dark @click="login()">Se connecter</v-btn>
                      </div>
                    </v-col>
                    <v-col cols="12" md="4" class="blue-grey darken-4">
                      ...
                      <div class="text-center">
                        <v-btn rounded outlined dark @click="step++">Inscrivez-vous!</v-btn>
                      </div>
                    </v-col>
                  </v-row>
                </v-window-item>
                <v-window-item :value="2">
                  <v-row class="fill-height">
                    <v-col cols="12" md="4" class="blue-grey darken-4">
                      <v-card-text class="white--text mt-12">
                        <h1 class="text-center display-1">Vous avez déja un compte?</h1>
                        <!-- <h5 class="text-center">To Keep connected with us please login with your personnel info</h5> -->
                      </v-card-text>
                      <div class="text-center">
                        <v-btn rounded outlined dark @click="step--">S'authentifier</v-btn>
                      </div>
                    </v-col>

                    <v-col cols="12" md="8">
                      <v-card-text class="mt-1">
                        <h1 class="text-center display-2 blue-grey--text text--darken-3">Créer un compte</h1>

                        <form @submit.prevent="handleSubmit">
                        <v-text-field  class="text-center mt-3"
                      ...
                      <div class="text-center mt-n5">
                        <v-btn class="creat" rounded color="#37474F" dark @click="handleSubmit()">S'inscrire</v-btn>
                      </div>
                    </v-col>
                  </v-row>
                </v-window-item>
