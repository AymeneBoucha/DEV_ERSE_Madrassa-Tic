                ...
                <v-card class="cardT">
                  <v-card-text>
                    <h2 class="subheading grey--text pt-7 text-center">
                      Est ce que vous confirmer la validation de cet rapport ?
                    </h2>
                    <div class="bouttonsV">
                      <v-btn @click="dialog2 = false"
                        ><span>Annuler</span></v-btn
                      >
                      <v-btn class="blue-grey darken-2" @click="validerRap()"
                  ...
                  <v-card-text>
                    ...
                    <div class="bouttonsD">
                      <v-btn @click="dialog1 = false"
                        ><span>Annuler</span></v-btn
                      >
                      <v-btn class="blue-grey darken-2" @click="InfoRap()"
  ...
  async created() {
    try {
      const res = await axios.get(
        `http://localhost:8080/api/madrasa-tic/moderator/getAllPendingRaportsByModerator`
      );
