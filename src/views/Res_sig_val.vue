<template>
  <div class="LesSignalements">
    <h1 class="subheading grey--text">Signalements Validé</h1>
    <v-container>
          ...
          <v-list-item-group class="lig" v-model="selectedItem" color="primary">
            ...
            <v-list-item>
              <v-list-item-content
                ...
                "
              >
                <v-list-item-title>Signalements Refusés</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-list-item-group>
        </v-list>
        ...
        >
          <v-card class="text-center ma-3 card1">
            ...
            <v-card-text class="titre">
              ...
              <div class="grey--text">
                <strong>Catégorie : </strong>{{ Signalement.Catégorie }}
              </div>
              <div class="grey--text">
                <strong>Publié le : </strong
                >{{ Signalement.Date_de_publication }}
              </div>
            </v-card-text>
                  ...
                  <v-card-text>
                    ...
                    <div class="bouttonsD">
                      <v-btn
                        ...
                        @click="Confirmer(Signalement.id)"
                        ><span class="text-lowercase">Confirmer</span></v-btn
                      >
    ...
    methods: {
        ...
        SignRef() {
          ...
          this.Signalements = res.data;*/
            let i = 0
          while (i < this.Signalements.length){
            if (this.Signalements[i].Etat !== 'Refusé'){
              this.Signalements.splice(i, 1)
            }else {
              i++
            }
